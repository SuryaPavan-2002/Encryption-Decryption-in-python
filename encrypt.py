...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('Surya Pavan', 'Please Choose one of Encryption or Decrption. Try again.')
...
wn.title("Encrypt and Decrypt your Messages with Surya Pavan")
